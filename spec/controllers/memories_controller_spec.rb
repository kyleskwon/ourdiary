...
RSpec.describe MemoriesController, type: :controller do
  ...
  # MemoriesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #index" do
    it "assigns all memories as @memories" do
      ...
      expect(assigns(:memories)).to eq([memory])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested memory as @memory" do
      memory = Memory.create! valid_attributes
      get :show, {:id => memory.to_param}, valid_session
  ...
  describe "GET #new" do
    it "assigns a new memory as @memory" do
      ...
      expect(assigns(:memory)).to be_a_new(Memory)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested memory as @memory" do
      memory = Memory.create! valid_attributes
      get :edit, {:id => memory.to_param}, valid_session
      expect(assigns(:memory)).to eq(memory)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Memory" do
        expect {
          post :create, {:memory => valid_attributes}, valid_session
      ...
      it "assigns a newly created memory as @memory" do
        ...
        expect(assigns(:memory)).to be_persisted
      end

      it "redirects to the created memory" do
        post :create, {:memory => valid_attributes}, valid_session
        expect(response).to redirect_to(Memory.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved memory as @memory" do
        post :create, {:memory => invalid_attributes}, valid_session
        expect(assigns(:memory)).to be_a_new(Memory)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested memory" do
        memory = Memory.create! valid_attributes
        put :update, {:id => memory.to_param, :memory => new_attributes}, valid_session
        memory.reload
      ...
      it "assigns the requested memory as @memory" do
        memory = Memory.create! valid_attributes
        put :update, {:id => memory.to_param, :memory => valid_attributes}, valid_session
        expect(assigns(:memory)).to eq(memory)
      end
      ...
      it "redirects to the memory" do
        memory = Memory.create! valid_attributes
        put :update, {:id => memory.to_param, :memory => valid_attributes}, valid_session
        expect(response).to redirect_to(memory)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the memory as @memory" do
        memory = Memory.create! valid_attributes
        put :update, {:id => memory.to_param, :memory => invalid_attributes}, valid_session
        expect(assigns(:memory)).to eq(memory)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested memory" do
      memory = Memory.create! valid_attributes
      expect {
        delete :destroy, {:id => memory.to_param}, valid_session
      }.to change(Memory, :count).by(-1)
    end
